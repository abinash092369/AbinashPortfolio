        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Decentralized Solutions</h4>
              <p>
                Designing smart contracts, Web3 platforms, and secure decentralized protocols. Passionate about trustless architectures.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Scalable Apps & Engines</h4>
              <p>
                Developing high-performance backends, clean APIs, and interactive frontends. Experienced in databases, caching, and containerized deployments.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
